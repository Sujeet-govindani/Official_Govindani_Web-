...
entranceTl.add(() => {
  gsap.to(cardsRef.current, {
    ...
    stagger: 0, // all same motion
        ...
        // Unique staggered entrance - cards fly in from different directions with rotation
        // cardsRef.current.forEach((card, index) => {
        //   if (!card) return;
          
        //   // Different entrance direction for each card
        //   const directions = [
        //     { x: -200, rotation: -180 }, // Left with spin
        //     { y: -200, rotation: 360 },   // Top with full rotation
        //     { x: 200, rotation: 180 }     // Right with spin
        //   ];
