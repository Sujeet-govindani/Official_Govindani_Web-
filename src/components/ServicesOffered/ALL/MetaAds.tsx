...
const style = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .hero { position: relative; min-height: 10vh; display: flex; align-items: center; overflow: hidden; padding: 0; margin: 0; }
...
const helpCards: HelpCard[] = [
  { icon: <IconChat />, title: "Increase Your Visibility", body: "Meta Ads places your business in front of millions of users on Facebook and Instagram when customers are most engaged with their feeds." },
  { icon: <IconLayers />, title: "Effective Audience Targeting", body: "Target by demographics, interests, behaviors, and custom audiences maximizing conversions from the most relevant audience." },
  ...
  { icon: <IconTrendUp />, title: "Gain a Competitive Edge", body: "Capture market share with competitor analysis and audience insights to understand how your ads perform relative to rivals." },
];

interface PpcService { icon: React.ReactNode; title: string; desc: string; items: string[]; }
const ppcServices: PpcService[] = [
  { icon: <IconSettings />, title: "Comprehensive Campaign Management", desc: "Our Meta Ads experts handle every aspect of your campaign, from audience research to creative production and ongoing optimization.", items: ["Audience research and segmentation", "Creative production and A/B testing", "Bid management and optimization"] },
...
const leadsCards: LeadCard[] = [
  { icon: <IconTarget />, title: "Drive Targeted Traffic", subtitle: "Targeted Audience Reach", desc: "Reach your ideal customers with precision targeting based on demographics, interests, and online behavior across Facebook and Instagram.", items: ["Highly targeted audience segmentation", "Tailored ad messaging for different segments", "Increased relevance and engagement"] },
  { icon: <IconDollar />, title: "Strategic Budget Allocation", subtitle: "Maximize Every Rupee", desc: "Optimize your advertising budget for maximum impact, focusing on the most profitable audiences and placements.", items: ["Budget allocation based on performance data", "Cost-effective bidding strategies", "Continuous budget optimization"] },
];

interface FactorCard { icon: React.ReactNode; title: string; desc: string; items: string[]; }
const factorCards: FactorCard[] = [
  { icon: <IconAward />, title: "Industry Experience", desc: "Look for a Meta Ads company with extensive experience in your industry, as they will have a better understanding of your target audience.", items: ["Industry-specific expertise", "Case studies and client testimonials", "Track record of success in similar industries"] },
  { icon: <IconUsers />, title: "Transparency & Communication", desc: "Choose a Meta Ads company that prioritizes transparency and open communication, providing regular updates and insights.", items: ["Clear communication channels", "Regular progress reports", "Responsive customer support team"] },
  { icon: <IconSettings />, title: "Customized Solutions", desc: "Seek a Meta Ads company that offers customized solutions tailored to your unique business needs and objectives.", items: ["Personalized campaign strategies", "Flexible service options", "Scalable solutions to accommodate growth"] },
];
...
const features: string[] = ["Boosted ROI", "Strong Understanding of Meta Ads", "Daily Tracking & Monitoring", "User Experience Flow", "Wide Variety of Niches"];
const logoChips: string[] = ["Facebook Ads", "Instagram Ads", "Reels Ads", "Messenger Ads"];
      ...
      <section className="hero">
        ...
        <div className="container">
          <div className="hero-grid">
            <div>
              <div className="label-pill"><span className="label-dot" />Social Media Advertising</div>
              <p className="hero-tag">Meta Ads</p>
              <h1 className="heading-xl hero-heading">Maximize Your Revenue with{" "}<em>Targeted</em>{" "}Meta Ads</h1>
              <div className="divider" />
              <p className="body-lg">Drive more leads and sales with our expertly managed Meta Ads services. Reach your ideal customers and boost your brand visibility with strategic social media campaigns tailored to your business goals.</p>
        ...
        <div className="container">
          <div className="about-grid">
            <div>
              ...
              <h2 className="heading-lg" style={{ marginBottom: 28 }}>Know About <span className="gold-accent">Meta Ads</span></h2>
              <p className="body-lg about-para">Investing in Meta Ads services is a surefire way for companies to increase revenue while minimizing risk. Our services are designed to deliver results, helping you achieve your business objectives efficiently and effectively.</p>
              <p className="body-lg about-para">We believe in complete transparency during your Meta advertising journey. You have constant access to your campaign, detailed reports, and all essential data. Our real time reporting gives you the insights to make informed decisions quickly.</p>
              <div className="divider" />
              <p style={{ fontFamily: "var(--heading)", fontSize: 16, fontWeight: 700, color: "#B89A5B", marginBottom: 18, letterSpacing: 1, textTransform: "uppercase" }}>Key Components of Our Meta Ads Services</p>
      ...
      <section className="section help-section" id="help">
        ...
        <div className="container" style={{ position: "relative", zIndex: 1 }}>
          <div className="help-top-card">
            <div className="label-pill" style={{ margin: "0 auto 16px" }}><span className="label-dot" />Meta Ads Benefits</div>
            <h2 className="heading-lg">How Meta Ads Can Help<br /><span className="gold-accent">Your Business?</span></h2>
            <p className="body-md" style={{ maxWidth: 520, margin: "16px auto 0" }}>Drive Targeted Traffic and unlock exponential growth across all your social media channels.</p>
        ...
        <div className="container" style={{ position: "relative", zIndex: 2, width: "100%" }}>
          <div className="ppc-bg-content">
            <div className="ppc-left-glass">
              ...
              <h2 className="heading-md" style={{ marginTop: 8, lineHeight: 1.3 }}>What Is Included In Our{" "}<span className="gold-accent">Meta Ads Marketing</span> Services?</h2>
              <div className="divider" style={{ marginTop: 24 }} />
              <p className="body-md">A full-stack Meta Ads solution built to drive measurable results for your business every step of the way.</p>
            </div>
      ...
      <section className="section" id="leads">
        <div className="container">
          <div style={{ textAlign: "center", maxWidth: 640, margin: "0 auto" }}>
            ...
            <h2 className="heading-lg">How Our Meta Ads Services Can Increase Your{" "}<span className="gold-accent">Leads & Sales?</span></h2>
          </div>
        ...
        <div className="container" style={{ position: "relative", zIndex: 1 }}>
          <div style={{ position: "relative", borderRadius: 20, overflow: "hidden", marginBottom: 8, padding: "48px 40px", background: "rgba(212,175,55,0.03)", border: "1px solid rgba(212,175,55,0.18)" }}>
            ...
            <div style={{ position: "relative", zIndex: 1, maxWidth: 560 }}>
              ...
              <h2 className="heading-lg">Factors to Evaluate in Your Search for a{" "}<span className="gold-accent">Meta Ads Company in India</span></h2>
            </div>
          </div>
