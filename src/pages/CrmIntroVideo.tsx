...
const CrmIntroVideo: React.FC<{ videoUrl?: string; logoUrl?: string }> = ({
    videoUrl = 'https://pub-8d8c06eb82144fca803dab6ccecd7b41.r2.dev/Images/IntroVideo/CRM%20system.mp4',
